...
<spring:message var="errorShort" code="catlogging.exception.refintg.short" arguments="${typeLabel}" />
<spring:message var="errorDetail" code="catlogging.exception.refintg.detail" arguments="${typeLabel}" />
