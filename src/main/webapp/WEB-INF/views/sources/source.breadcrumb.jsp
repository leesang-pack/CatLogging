	...
	<ul class="breadcrumb">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				<li><a href="<c:url value="/c/sources/${activeSource.id}/logs" />"><i class="glyphicon glyphicon-list"></i> <spring:message code="catlogging.nav.logs"/></a></li>
				<li><a href="<c:url value="/c/sources/${activeSource.id}" />"><i class="glyphicon glyphicon-edit"></i> <spring:message code="catlogging.common.form.edit"/></a></li>
				<li class="divider"></li>
