...
<spring:message code="catlogging.sniffers.scheduled.true" var="nlsOn" javaScriptEscape="true" text=""/>
<spring:message code="catlogging.sniffers.scheduled.true" var="nlsOff" javaScriptEscape="true" text=""/>
...
<ul class="breadcrumb" ng-init="nlsOn='${nlsOn}';nlsOff='${nlsOff}'">
	<li><a href="<c:url value="/c/sniffers" />"><spring:message code="catlogging.breadcrumb.sniffers" text=""/></a></li>
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
			<li><a href="<c:url value="/c/sniffers/${activeSniffer.id}/events" />"><i class="glyphicon glyphicon-bullhorn"></i> <spring:message code="catlogging.nav.events" text=""/></a></li>
			<li><a href="<c:url value="/c/sniffers/${activeSniffer.id}" />"><i class="glyphicon glyphicon-edit"></i> <spring:message code="catlogging.common.form.edit" text=""/></a></li>
			<li><a href="<c:url value="/c/sniffers/${activeSniffer.id}/status" />"><i class="glyphicon glyphicon-play-circle"></i> <spring:message code="catlogging.common.form.control" text=""/></a></li>
			<li class="divider"></li>
		...
		<sup>
			<span class="label label-success" ng-if="scheduleInfo.scheduled"><spring:message code="catlogging.sniffers.scheduled.true" text=""/></span>
			<span class="label label-default" ng-if="!scheduleInfo.scheduled"><spring:message code="catlogging.sniffers.scheduled.false" text=""/></span>
		</sup>
	</li>
	<li class="active"><spring:message code="${param.context}" text=""/></li>
</ul>
