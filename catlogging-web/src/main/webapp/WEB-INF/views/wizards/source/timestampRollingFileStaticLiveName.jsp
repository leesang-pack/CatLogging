...
<div id="source-wildcard-rolling-file-wizard">
	<lsf-info-label label="<spring:message code="catlogging.common.timestampStatic.label.1"/>" class="text-muted">
...
<%--		<div class="col-md-12">--%>
		<lsf-form-group class="form-group required" field-name="pattern" field-path="pattern" bind-errors="bindErrors">
			<t:ngFormFieldWrapper cssClass="form-group col-md-12 required" fieldName="pattern">
				<lsf-info-label label="<spring:message code="catlogging.common.timestampStatic.label.4"/>:" for="pattern">
	...
	<div class="row">
		<div class="col-md-8">
			<lsf-form-group class="form-group required" field-name="pastLogsSuffixPattern" field-path="pastLogsSuffixPattern" bind-errors="bindErrors">
				<lsf-info-label label="<spring:message code="catlogging.common.timestampStatic.label.2"/>:" for="pastLogsSuffixPattern">
