 ...
 * coexists with previous versions of catlogging where all events were stored to
...
public class SimpleSnifferIdIndexNameStrategy implements IndexNamingStrategy {
	static final String PROP_ES_INDEX_NAME_PREFIX = "catlogging.es.indexNamePrefix";
	@Deprecated
	static final String PROP_LEGACY_ES_INDEX_NAME = "catlogging.es.indexName";
