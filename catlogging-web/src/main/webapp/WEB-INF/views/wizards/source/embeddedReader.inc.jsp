...
<!-- Requires bound "reader" attribute of type com.catlogging.reader.LogEntryReader -->
...
<script type="text/javascript">
	catloggingNgApp.controllerProvider.register(
		"ReaderBeanWizardControllerWrapper", ['$scope', function ($scope) {
			$scope.wizards=${logfn:jsonify(logfn:wizardsInfo('com.catlogging.reader.LogEntryReader', pageContext.response.locale))};
			...
			$scope.$parent.$watch('bindErrors', function(newValue, oldValue) {
				...
				$scope.bindErrors = catlogging.stripPrefix(newValue, "reader.");
		    });
