...
/**
 * Launches the Jetty server with catlogging's web app.
 * 
 * @author Tester
 * 
 */
public class JettyLauncher {
	...
	public void start(final String[] args, final URL warLocation) throws Exception {
		...
		connector.setPort(Integer.parseInt(System.getProperty("catlogging.httpPort", "8082")));
		connector.setHost(System.getProperty("catlogging.httpListenAddress", "0.0.0.0"));
		...
		String ctxPath = System.getProperty("catlogging.contextPath", "/");
