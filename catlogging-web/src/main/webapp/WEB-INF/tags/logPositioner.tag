...
<%@taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
<%@tag import="com.catlogging.model.RollingLog"%>
<%@tag description="Input for a log position" pageEncoding="UTF-8"%>
<%@attribute name="log" required="true" type="com.catlogging.model.Log"%>
...
<%@attribute name="pointerTpl" required="true" type="com.catlogging.model.LogPointer"%>
