...
import com.catlogging.event.processing.ScheduleInfoAccess;
import com.catlogging.event.processing.SnifferJobManager;
...
import com.catlogging.model.h2.H2LogSourceProvider;
...
public class H2SnifferPersistenceTest {
	...
	/**
	 * Reported by https://github.com/catlogging/catlogging/issues/78
	 */
	@Test
	@DirtiesContext
