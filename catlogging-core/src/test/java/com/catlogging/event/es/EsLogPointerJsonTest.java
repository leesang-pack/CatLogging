...
public class EsLogPointerJsonTest {
	...
	public void testOldSerializationWithNativeJsonLogPointerRepresentation() throws IOException {
		final String oldJson = "{\"@types\":{\"lf_entries\":[\"LENTRY\"],\"lf_timestamp\":\"DATE\",\"lf_snifferId\":\"LONG\",\"lf_logSourceId\":\"LONG\",\"lf_logPath\":\"STRING\",\"lf_published\":\"DATE\"},\"lf_entries\":[{\"@types\":{\"date\":\"STRING\",\"lf_timestamp\":\"DATE\",\"priority\":\"STRING\",\"lf_severity\":\"SEVERITY\",\"category\":\"STRING\",\"message\":\"STRING\",\"lf_startOffset\":\"LPOINTER\",\"lf_raw\":\"STRING\",\"lf_endOffset\":\"LPOINTER\"},\"date\":\"2016-04-08 23:36:46,736\",\"lf_timestamp\":1460151406736,\"priority\":\"DEBUG\",\"lf_severity\":{\"o\":5,\"c\":7,\"n\":\"DEBUG\"},\"category\":\"com.catlogging.event.h2.H2SnifferPersistence\",\"message\":\"Storing inc data for sniffer=com.catlogging.event.SnifferPersistence$AspectSniffer@6275df71, source=com.catlogging.model.h2.H2LogSourceProvider$SourceRowMapper$1@664a57e7 and log=RollingLog [liveLog=FileLog [file=/home/Tester/catlogging/logs/catlogging.log]] with next offset: RollingLogPointer [path=/home/Tester/catlogging/logs/catlogging.log, filePointer=SingleFilePointer [offset=8026804, size=36465380]]\",\"lf_startOffset\":{\"json\":{\"p\":\"/home/Tester/catlogging/logs/catlogging.log.2016-04-08\",\"l\":false,\"f\":false,\"h\":-97277146,\"u\":{\"o\":61187613,\"s\":643460743}},\"eof\":false,\"sof\":false},\"lf_raw\":\"2016-04-08 23:36:46,736 DEBUG [com.catlogging.event.h2.H2SnifferPersistence] Storing inc data for sniffer=com.catlogging.event.SnifferPersistence$AspectSniffer@6275df71, source=com.catlogging.model.h2.H2LogSourceProvider$SourceRowMapper$1@664a57e7 and log=RollingLog [liveLog=FileLog [file=/home/Tester/catlogging/logs/catlogging.log]] with next offset: RollingLogPointer [path=/home/Tester/catlogging/logs/catlogging.log, filePointer=SingleFilePointer [offset=8026804, size=36465380]]\",\"lf_endOffset\":{\"json\":{\"p\":\"/home/Tester/catlogging/logs/catlogging.log.2016-04-08\",\"l\":false,\"f\":false,\"h\":-97277146,\"u\":{\"o\":61188095,\"s\":643460743}},\"eof\":false,\"sof\":false}}],\"lf_timestamp\":1460151406736,\"lf_snifferId\":1,\"lf_logSourceId\":1,\"lf_logPath\":\"/home/Tester/catlogging/logs/catlogging.log\",\"lf_published\":1469964960113}";
		...
		Assert.assertTrue("Invalid pointer data: " + test.getEntries().get(0).getStartOffset().getJson(),
				test.getEntries().get(0).getStartOffset().getJson().contains("catlogging"));
		...
		Assert.assertTrue("Invalid pointer data: " + test.getEntries().get(0).getEndOffset().getJson(),
				test.getEntries().get(0).getEndOffset().getJson().contains("catlogging"));
