...
<ul class="breadcrumb">
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
			<li><a href="${showHref}"><i class="glyphicon glyphicon-search"></i> <spring:message code="catlogging.common.form.viewer" text=""/></a></li>
			<li><a href="${infoHref}"><i class="glyphicon glyphicon-info-sign"></i> <spring:message code="catlogging.common.form.info" text=""/></a></li>
		</ul>
	</li>
</ul>