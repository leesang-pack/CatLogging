...
<script type="text/javascript">
	catloggingNgApp.controller(
		...
		function($scope, $http, $log, $uibModal) {
		    $scope.scannerWizards=${logfn:jsonify(logfn:wizardsInfo('com.catlogging.event.Scanner', pageContext.response.locale))};
			$scope.readerStrategyWizards=${logfn:jsonify(logfn:wizardsInfo('com.catlogging.event.LogEntryReaderStrategy', pageContext.response.locale))};
		    $scope.publisherWizards=${logfn:jsonify(logfn:wizardsInfo('com.catlogging.event.Publisher', pageContext.response.locale))};
			$scope.scannerFilterWizards=${logfn:jsonify(
					logfn:mergeLists(
						logfn:wizardsInfo('com.catlogging.fields.filter.FieldsFilter', pageContext.response.locale),
						logfn:wizardsInfo('com.catlogging.event.filter.EventFilter', pageContext.response.locale)
					)
				)};
		    $scope.sharedScope = {};
		    $scope.testSession = {};
